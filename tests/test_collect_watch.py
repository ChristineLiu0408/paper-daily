...
class CollectWatchTest(unittest.TestCase):
    ...
    def test_report_generation_writes_markdown_and_json(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(md_path.name, "2026-07-06.md")
            self.assertEqual(json_path.name, "2026-07-06.json")
    ...
    def test_report_generation_writes_all_markdown_and_xlsx_when_raw_records_exist(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            all_md_path = Path(tmpdir) / watch["id"] / "2026-07-06_all.md"
            all_xlsx_path = Path(tmpdir) / watch["id"] / "2026-07-06_all.xlsx"
